...
from RotNet.utils.rotnet_utils import REGEX_IMG
from RotNet.io_managers.rotnet_manager import RotNetManager
...
class RotNet(ClassificationModel):
    ...
    def get_callbacks(self):
        ...
        suffix = "regression" if self.regression else "classification"
        file_name = "{}-{}-{}".format(self.model_name, self.backbone, suffix)
